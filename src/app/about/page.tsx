export default function About() {
  return (
    <div className="px-4 py-16 space-y-16">
      ...
      <section className="grid md:grid-cols-3 gap-8 border-t border-border-base pt-8">
        <div className="md:col-span-1">
            <div className="w-full aspect-square border border-border-base bg-bg-surface flex items-center justify-center p-4">
               <div className="w-full h-full border border-border-base border-dashed flex items-center justify-center text-sm font-mono text-text-primary/50">
        ...
        <div className="md:col-span-2 space-y-6 text-lg">
            ...
            <div className="border border-border-base p-6 mt-8 space-y-4 bg-bg-surface">
                <h3 className="font-bold border-b border-border-base pb-2 font-mono text-sm uppercase">Operating Principles</h3>
