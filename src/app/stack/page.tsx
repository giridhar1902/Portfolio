    ...
    <div className="px-4 py-16 space-y-16">
      ...
      <section className="border-t border-border-base pt-8">
         <div className="grid md:grid-cols-2 gap-8">
            <div className="border border-border-base p-6 space-y-4">
                <h2 className="text-2xl font-bold border-b border-border-base pb-2">Frontend</h2>
            ...
            <div className="border border-border-base p-6 space-y-4">
                <h2 className="text-2xl font-bold border-b border-border-base pb-2">Backend & Database</h2>
                <ul className="space-y-2 font-mono text-sm">
             ...
             <div className="border border-border-base p-6 space-y-4">
                <h2 className="text-2xl font-bold border-b border-border-base pb-2">AI Workflow</h2>
                <ul className="space-y-2 font-mono text-sm">
            ...
            <div className="border border-border-base p-6 space-y-4">
                <h2 className="text-2xl font-bold border-b border-border-base pb-2">Deploy & Ops</h2>
                <ul className="space-y-2 font-mono text-sm">
