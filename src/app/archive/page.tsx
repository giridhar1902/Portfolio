      ...
      <section className="border-t border-primary pt-8">
        <div className="overflow-x-auto">
            <table className="w-full text-left border-collapse">
                <thead>
                    <tr className="border-b-2 border-primary font-mono text-sm">
                ...
                <tbody className="font-mono text-sm">
                    <tr className="border-b border-primary/30">
                        ...
                        <td className="py-4 pr-4 text-primary/80">WhatsApp-first rent collection</td>
                    ...
                    <tr className="border-b border-primary/30">
                        ...
                        <td className="py-4 pr-4 text-primary/80">Invoice OCR tool for freelancers</td>
                        <td className="py-4"><span className="border border-primary px-2 py-1">Acquired</span></td>
                    </tr>
                    <tr className="border-b border-primary/30 text-primary/50">
                        <td className="py-4 pr-4">2025</td>
                        <td className="py-4 pr-4 font-bold">LocalLens</td>
                        <td className="py-4 pr-4">Hyper-local newsletter aggregator</td>
                        <td className="py-4"><span className="border border-primary/30 px-2 py-1">Sunset</span></td>
                    </tr>
                     <tr className="border-b border-primary/30 text-primary/50">
